<template>
    <div class="content">
        <div class="head">
            <div class='headshow'>
                <div class="filter">
                    <input type="text" v-model.lazy='keyWord' class='int' placeholder="搜索关键词">
                    <el-date-picker
                        v-model="timeValue"
                        type="date"
                        size="small"
        ...
        <div class="section">
            <div class="table_top">
                <div>
                    ...
                    <span @click='addClient = true'>新增</span>
                    <span @click='garbageSwitch = true'>转入垃圾客户</span>
    ...
    export default {
        ...
        methods:{
            ...
            changeTableData(num=0){
                // http://lishaokai.cn:8080/love
                this.$axios.get('dayou/data.json')
                .then((data)=>{
                    console.log(data)
